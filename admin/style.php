...
background-image:url(<?php echo get_template_directory_uri(); ?>/images/grey/zeile.png);
...
.boxgrid    h3 > a { color:#<?php echo $body_bg_color; ?>; font:15px Arial, sans-serif; letter-spacing:0; font-weight: bold; padding-left:0px;
}
