...
<?php if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
	...
	<table class="forum">
		<thead>
			<tr>
				<th id="th-title"><?php _e( 'Topic', 'cc' ); ?></th>
		...
		<tbody>
			...
			<tr class="<?php bp_the_topic_css_class(); ?>">
				<td class="td-title">
					...
					<p class="topic-meta">
						<span class="topic-by"><?php /* translators: "started by [poster] in [forum]" */ printf( __( 'Started by %1$s', 'cc' ), bp_get_the_topic_poster_avatar( 'height=20&width=20') . bp_get_the_topic_poster_name() ); ?></span>
